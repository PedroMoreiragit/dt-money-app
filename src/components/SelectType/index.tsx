    ...
    return (
        <View className="flex-row justify-between gap-2 mt-2">
            <TouchableOpacity
                ...
                className={clsx('flex-row items-center p-2 flex-1 justify-center h-[58px] rounded-lg',

                    typeId === TransactionTypes.REVENUE ? "bg-accent-brand" : "bg-background-tertiary"
                )}>
                <MaterialIcons name="arrow-circle-up" color={
                    typeId === TransactionTypes.REVENUE ? colors.white : colors['accent-brand-light']
                }
                    size={30}
                    className="mr-2"
                />
            ...
            <TouchableOpacity
                ...
                <MaterialIcons name="arrow-circle-down"
                    color={
                        typeId === TransactionTypes.EXPENSE ? colors.white : colors['accent-red']
                    }
                    size={30}
                    className="mr-2" />
