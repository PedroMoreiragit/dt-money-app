...
import { Modal, View, TouchableWithoutFeedback, Text, TouchableOpacity, ActivityIndicator } from "react-native";
                            ...
                            <View className="m-5 bg-background-secondary rounded-[16] p-8 items-center shadow-lg w-[90%] h-[322] z-9">
                                <View className="w-full flex-row justify-between items-center border-b border-gray-300 pb-6">
                                    <View className="flex-row gap-6 items-center">
                                        <MaterialIcons name="error-outline" className="mr-4" color={colors.gray[400]} size={25} />
                                ...
                                <View className="p-3 flex-1 border-b border-gray-300 items-center justify-center">
                                    <Text className="text-gray-500 text-lg leading-8">Tem certeza que deseja apagar esta transação? Esta ação
                                        não pode ser desfeita
                                    </Text>
                                </View>

                                <View className="flex-row justify-end gap-4 w-full p-6 pb-0 pr-0">
                                    <TouchableOpacity onPress={hideModal} className="w-[100] p-3 rounded-[6] bg-none border-2 border-accent-brand items-center justify-center">
                                        <Text className="text-accent-brand">Cancelar</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity onPress={handleDeleteTransaction} className="w-[100] p-3 rounded-[6] bg-none  items-center bg-accent-red-background-primary justify-center">
